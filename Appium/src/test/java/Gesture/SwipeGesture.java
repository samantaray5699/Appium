...
public class SwipeGesture {
	...
	public void tc() throws MalformedURLException
	{
		...
		js.executeScript("mobile: swipeGesture",ImmutableMap.of("left", 150, "top", 1000, "width", 783, "height", 1000, "direction", "left",  "percent",1.0));
		js.executeScript("mobile: swipeGesture",ImmutableMap.of("left", 150, "top", 1000, "width", 783, "height", 1000, "direction", "right","percent",0.75));
